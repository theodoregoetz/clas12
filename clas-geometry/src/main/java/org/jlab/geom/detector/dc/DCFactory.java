...
/**
 * A Drift Chamber (DC) {@link org.jlab.geom.base.Factory Factory}.
 * <p>
 * Factory: <b>{@link org.jlab.geom.detector.dc.DCFactory DCFactory}</b><br> 
 * Hierarchy: 
 * <code>
 ...
 * </code>
 * <p>The drift chambers are grouped into three regions, however this API does
 * not support regions.  Instead the drift chambers are grouped into six
 * superlayers such that region = floor(superlayer/2).
 * 
 * <font color="red"><b>Note:</b></font> The DC is <b>not</b> currently being 
 * constructed accurately. See {@link #midpointXOffset(int, double)} for 
 * details.
 * @author jnhankins
 */
public class DCFactory implements Factory<DCDetector, DCSector, DCSuperlayer, DCLayer> {
