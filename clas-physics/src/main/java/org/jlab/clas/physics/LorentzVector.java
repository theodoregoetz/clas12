...
public class LorentzVector {
    ...
    public double px()     { return vector.x();}
    public double py()     { return vector.y();}
    public double pz()     { return vector.z();}
    public double p()      { return vector.mag();}
    public double theta()  { return vector.theta();}
    public double phi()    { return vector.phi();}
    public double mass2()  { return (energy*energy-vector.mag2());} 
    public double mass()   { 
    ...
    {
        if(energy==0) return new Vector3(0.,0.,0.);
    ...
    public void boost(double bx, double by, double bz)
    {
        ...
        vector.setXYZ(px() + gamma2*bp*bx + gamma*bx*e(),
    ...
    public Vector3 vect() { return vector;}
